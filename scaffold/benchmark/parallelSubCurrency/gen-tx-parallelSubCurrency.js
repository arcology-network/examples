...
async function main() {
  ...
  frontendUtil.ensurePath('benchmark/parallelSubCurrency/data');
  ...
  frontendUtil.ensurePath('benchmark/parallelSubCurrency/data/mint');
  const handle_mint=frontendUtil.newFile('benchmark/parallelSubCurrency/data/mint/mint.out');
  ...
  frontendUtil.ensurePath('benchmark/parallelSubCurrency/data/send');
  const handle_send=frontendUtil.newFile('benchmark/parallelSubCurrency/data/send/send.out');
